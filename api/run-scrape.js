...
export default async function handler(request, response) {
    ...
    try {
        try {
            let { retailers, mode, workspace = 'beauty', maxReviews } = request.body || {};
            ...
            const maxReviewsCount = maxReviews !== undefined && maxReviews !== '' ? parseInt(maxReviews) : 5;
            console.log(`Configuring scrape with Max Reviews: ${maxReviewsCount}`);
